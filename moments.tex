...
We define the coefficient $\phi$ as follows
\begin{align}
	\operatorname{E}(x^3) = \mu^3 (1+\kappa)^2 (1+\phi),
\end{align}
where $\mu$ is the mean and $\kappa$ is the square of the coefficient of variation.
Then, for the gamma distribution $\phi$ is equal to $\frac{\kappa}{\kappa + 1},$ and for the log-normal distribution is equal to $\kappa$.
