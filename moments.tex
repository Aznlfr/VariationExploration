...
For $x \sim \operatorname{U}(a,b)$, the mean, variance, and the third raw moments are
\begin{align*}
	\mu & =\frac{1}{2}(a+b) \\
...
\end{align*}
Substituting $3\kappa -1$ for $\frac{-ab}{\mu^2}$ in the RHS of \Cref{eq_phi_unif} results in 
\begin{align}
