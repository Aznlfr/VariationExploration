...
\begin{figure}[H] 
\includegraphics[width=1\linewidth]{figs/timePlot.Rout}
\caption{A seasonally forced epidemic with a period of $60$ (\Cref{eq_Erlang} with $m=1$ and $\kappa=0$).
		The simulation started at $y(0)=1^{-9}$ and was run for $200$ time units.
...
\begin{figure}[H] 
	\centering
	\includegraphics[width=1.35\linewidth]{figs/RcbarPlotVaryingSigma.Rout}
...
\begin{figure}[H]
	\includegraphics[width=1.35\linewidth, trim=0cm 0cm 0cm 1cm, clip]{figs/RcbarPlotVaryingKappa.Rout}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=1.2\linewidth]{figs/ErlangMoments.Rout}
	...
	$\alpha$ and $\sigma$ are set to zero, and the duration of the simulation is $100$ time units, starting from the initial condition $y(0)=1^{-9}$.}
\end{figure}
...
\begin{figure}[H]
	\includegraphics[width=1.2\linewidth]{figs/bars.Rout}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=1\linewidth]{figs/RiMoments.Rout}
	\caption{The mean and variance of instantaneous reproductive number for different number of infectious compartments $(m=1,2,4)$, and transmission rates $(\beta_0 = 1.5,5,8)$.
		$\alpha$ and $\sigma$ are set to zero, and the duration of the simulation is $100$ time units, starting from the initial condition $y(0)=1^{-9}$.
		...
		Panel b reports the variance in $R_i$ ($\frac{\int R_i^2(\tau) i(\tau) d\tau}{\int i(
			\tau)d\tau} - \mu^2$).
		Panel c show the time-averaged mean of $R_i$ ($\mu_t = \frac{\int R_i d\tau}{\int d\tau}$), and panel d reports the variance in $R_i$ averaged by time ($\frac{\int R_i^2(\tau) d\tau}{\int d\tau} - \mu_t^2$). }
\end{figure}
%\begin{figure}[H]
%	\centering
...
\begin{figure}[H]
	\centering
	\includegraphics[width=1\linewidth]{figs/RibarPlotVaryingSigma.Rout}
...
\begin{equation}
\text{CV}^2_g  =	\frac{4\gamma_i\text{CV}^3_i + 12\text{CV}_i^2 + 4}{3(1+\text{CV}_i^2)^2}-1
\end{equation}
