...
\caption{A seasonally forced epidemic with a period of $60$ (\Cref{eq_Erlang} with $m=1$, $\gamma=1$, $\kappa=0$).
	Panels d and e depict the mean and variance in cohort's case reproductive number, respectively. 
	The transmission rate is periodic with a three-month period (panel c).
